...
class CMA_LSTM(nn.Module):
    def __init__(self, num_layers, hidden_size):
        ...
        self.text_av_cma = CMA_LSTM_Block(hidden_size)
        self.hidden_sa = CMA_LSTM_Block(hidden_size)
        self.hidden_av_cma = CMA_LSTM_Block(hidden_size)
...
class LSTM_AVQA_Model(nn.Module):
    ...
    def forward(self, text_input_ids, text_attention_mask, labels, audio_feats, frame_feats):
        ...
        text_audio_feats = self.lstm_text_audio(text_feats, audio_feats)
        text_frame_feats = self.lstm_text_frame(text_feats, frame_feats)
        text_av_feats = self.lstm_text_av(text_feats, av_feats)
