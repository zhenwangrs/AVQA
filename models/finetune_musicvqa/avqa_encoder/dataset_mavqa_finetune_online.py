...
class MavqaDataset_finetune_online(Dataset):
    def __init__(self, config, tokenizer, image_processor, mode='train'):
        ...
        self.ans_set =  ['yes', 'no',
                         ...
                         'indoor', 'outdoor',
                         'cello', 'congas', 'pipa', 'ukulele', 'piano', 'accordion', 'clarinet',
    ...
    def get_av_data(self, video_id):
        ...
        start_frame = random.randint(1, rand_range)
...
if __name__ == '__main__':
    ...
    mavqa_dataset = MavqaDataset_finetune_online(config, tokenizer, image_processor, mode='train')
