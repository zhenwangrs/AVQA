...
def train():
    ...
    mae_pretrain_params = list(model.mae_pretrain.parameters())
    clip_params = list(model.clip.parameters())

    av_fusion_params = list(model.av_fusion.parameters())
    lstm_text_audio_params = list(model.lstm_text_audio.parameters())
    lstm_text_frame_params = list(model.lstm_text_frame.parameters())
    lstm_text_av_params = list(model.lstm_text_av.parameters())
    ...
    # params = [
    #     {'params': av_fusion_params + lstm_text_audio_params
    #                + lstm_text_frame_params + lstm_text_av_params
    #                + classifier_params, 'lr': config.train.lr},
    # ]
